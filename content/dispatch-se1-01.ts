 ...
 * 2026-08-03 revision. Text is the author's, transcribed in full; scene
 * headings come from the draft's own location/date slugs.
 *
  ...
  scenes: [
    {
      ...
      paragraphs: [
        ...
        'Amara removed her headset and stretched until the bones in her shoulders clicked. On the largest wall display, the Earth hung as a delayed blue image beside a map of relay traffic moving between Mars, the lunar stations, the orbital platforms and the ships scattered through the inner Solar System.',
        'Nothing about it felt miraculous anymore. Cargo schedules were late. A drilling unit had lost a wheel. The European greenhouse team was arguing with the East African nutrition unit over water allocation, and someone in Habitat Three had once again used too much bandwidth to stream a football match from Earth. Mars had become a place where people complained about work, which Amara considered humanity’s greatest achievement.',
        ...
        '“Arun,” she said. He woke sharply and declared, “I’m awake.”',
        '“You are now.”',
        'Amara returned to her station, carrying the unfinished cup. A narrow pulse stood on the screen. It was too clean to be background radiation, too evenly spaced to be weather interference.',
        ...
        '“No registered beacon uses this interval,” Amara said as Commander Tanaka approached and asked for the source.',
        ...
        'Arun leaned toward the display. “That calculation is wrong.” Amara ran it again, but the answer did not change.',
        'A soft mechanical voice announced that Array Seven had confirmed acquisition.',
        ...
        'The repeated tone broke into a sequence. The station translation systems searched for language, mathematics, navigational code, machine protocol. For three seconds, nothing appeared.',
        'Then a line of text formed on the main display.',
        'WE ARE HERE.',
        ...
        'Amara reached for the transmission control, but before she touched it Array Two chimed. A second signal appeared from a different star. Then Array Nine found another, and another.',
        'Across the wall, points of light began appearing one after the other, until the map of nearby space looked less like a sky and more like a city waking at night.',
        'Each source carried the same message.',
        'WE ARE HERE.',
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        ...
        '“What is it?”',
        '“I don’t know yet.”',
        'She opened the file before he arrived.',
        'The screen went black. For several seconds, nothing happened. Then a figure appeared.',
        ...
        'Behind the figure stood others wearing the same face.',
